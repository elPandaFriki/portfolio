        ...
        <Graph>
          ...
          >
            ...
            {data.map((card: any, cardIndex: number) => {
              ...
              const src = new URL(card.media, import.meta.url);
              return (
                <Card key={cardIndex}>
                  <Img src={src.toString()} alt={card.title} />
                  <Divider>
                  ...
                  <Typography variant={"subtitle1"}>
                    {dates.map((date: string, dateIndex: number) => {
                      return (
                  ...
                  {description.map((content: any, contentIndex: number) => {
                    return (
